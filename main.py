...
def main():
    ...
    st.markdown("<p style='text-align: center>Auf der folgenden Seite werden Tweets von Elon Musk zwischen dem **02.12.2019 und dem 22.04.2022** in einem Dataframe abgebildet.</p>", unsafe_allow_html=True)
